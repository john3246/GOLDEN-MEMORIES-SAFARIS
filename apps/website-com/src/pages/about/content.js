...
export const aboutHero = {
  ...
  motto: 'Every Safari With A sparkle of Golden Memories.',
  cta: 'Get in touch',
  image: GM.hero,
};
...
export const aboutCredentials = [
  {
    title: 'TATO Registered',
    body: 'Registered with the Tanzania Association of Tour Operators, ensuring compliance with industry standards, safety protocols, and ethical business practices.',
  },
  {
    title: 'TANAPA Partner',
    body: 'Authorized partner of Tanzania National Parks, with direct access to park fees, permits, and up-to-date information on park conditions and wildlife movements.',
  },
  {
    title: 'Responsible Tourism',
    body: 'Committed to sustainable travel practices including wildlife conservation support, community engagement, plastic reduction, and cultural respect initiatives.',
  },
  {
  ...
  },
  {
    ...
    body: 'Fully licensed tour operator with comprehensive liability insurance and emergency evacuation coverage, ensuring your safety and peace of mind throughout your journey.',
  },
  {
    title: 'Local & Authentic',
    body: '100% Tanzanian-owned and operated. Your safari directly supports local families, guides, lodges, and conservation efforts across Tanzania.',
  },
];
