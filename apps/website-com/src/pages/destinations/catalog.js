...
export const destinationPlaces = [
  ...
  },
  {
    ...
    kicker: 'Jane Goodall’s forest',
    tagline: 'Steep chimpanzee country on Lake Tanganyika — compact, walked, not driven',
    ...
    paragraphs: [
      'Gombe Stream is Tanzania’s smallest national park: a strip of steep forest on Lake Tanganyika where Jane Goodall began chimpanzee research in 1960. There are no game-drive loops. You fly to Kigoma, boat along the lake, then walk. Habituated chimps are the reason to come; colobus, baboons and forest birds fill the hours you are not on a trek. Golden Memories Safaris places Gombe on longer journeys that already include the north or south — the far west is expensive to reach, with infrequent flights, and it does not replace a savannah safari.',
      'Compared with Mahale further south on the same lake, Gombe is shorter, steeper, and closer to Kigoma. Trails are demanding; rains make them harder. Dry months (May–October) are the sensible window. This is not Katavi’s buffalo country and not Serengeti’s plains. It is a forest pilgrimage: boat, boots, and a few intense hours with primates.',
    ],
    highlights: [
      { title: 'Chimpanzee trekking', body: 'Habituated communities in the forest where modern chimp research began.' },
      { title: 'Lake Tanganyika access', body: 'Boat in, walk in — no 4x4 circuit. Forest and water, not grassland.' },
      { title: 'Compact and intense', body: 'Tanzania’s smallest park; a few nights are enough if you are also seeing Mahale or flying onward.' },
    ],
    seasons: [
      { title: 'May–October', body: 'Easier forest walking and more reliable tracking.' },
      { title: 'Rains', body: 'Possible, but steeper, muddier trails. We prefer the dry if your dates can move.' },
    ],
    wildlife: [
      'Chimpanzees — the focus of every visit.',
      'Red colobus, olive baboons, and a dense forest bird list.',
      'Lake shore: the water is the highway, not a snorkel resort (Mahale is the beachier sibling).',
    ],
    activities: [
      { title: 'Chimp trekking', body: 'Guided forest walks to habituated groups. Fitness matters; this is not a boardwalk.' },
      { title: 'Lake boat', body: 'Transfers and the only way in; the shoreline is the park’s other landscape.' },
      { title: 'Forest hiking', body: 'Shorter walks for birds and colobus when you are not on a chimp permit day.' },
    ],
    attractions: ['Chimpanzee trekking', 'Lake Tanganyika', 'Gombe forest trails', 'Kigoma gateway'],
    faqs: [
      ...
      { q: 'How do I get there?', a: 'Typically fly to Kigoma, then boat to the park. Flights into the west are infrequent and costly; we build Gombe into a longer itinerary, not a weekend add-on from Arusha.' },
      { q: 'Gombe or Mahale?', a: 'Gombe is shorter and closer to Kigoma. Mahale is a fly-in lodge stay with clearer lake swimming and, usually, slightly easier late-season chimp walks. We choose by nights and budget.' },
    ],
    facts: [
      ['Region', 'Western Tanzania, Lake Tanganyika'],
      ['Known for', 'Jane Goodall chimpanzee research, forest trekking'],
      ['Access', 'Fly to Kigoma, then boat'],
  ...
  },
  {
    ...
    kicker: 'Lake beaches and chimps',
    tagline: 'The far-west fly-in: habituated chimpanzees, gin-clear Tanganyika, and no road in',
    region: 'Western Tanzania',
    regionSlug: 'western-tanzania',
    cta: 'Plan Mahale',
    image: GM.savanna,
    ...
    match: ['mahale'],
    paragraphs: [
      'Mahale Mountains National Park occupies a remote stretch of Lake Tanganyika in far-western Tanzania: forested peaks, a startlingly clear shoreline, and the country’s finest chimpanzee viewing. Chimp sightings here are exceptionally reliable — but “viewing” can mean an hour’s walk or a strenuous day. You are allowed one hour with the animals once you find them. August to October is the easiest window, when groups move down the mountains for food; other months simply mean more climbing. Smaller primates, strong forest birding, hippo and crocodile along the shore, and the occasional leopard complete the list. This is not a Big Five game-drive park.',
      'Getting here is the filter. Flights from Arusha and Ruaha do not leave every day, and the west can cost more than a thousand dollars a person in the air. That isolation is the point. Once you land, the days are trekking, kayaking, snorkelling, fishing, waterfall walks, and time on a beach that would be famous if it were easier to reach. In the dry season a combination with Katavi — huge buffalo and elephant herds further inland — is the classic western pairing. Gombe, closer to Kigoma, is the shorter, steeper alternative.',
    ],
    highlights: [
      { title: 'Best chimp trekking in Tanzania', body: 'Habituated communities, one hour with them when you arrive, easier walks later in the dry season.' },
      { title: 'Lake Tanganyika beach', body: 'Kayak, snorkel and swim in clear water after the forest — a combination no northern park offers.' },
      { title: 'Genuinely remote', body: 'Infrequent, expensive flights. Few other travellers. A destination stay, not a day trip from Arusha.' },
      { title: 'Pairs with Katavi or the south', body: 'Add Katavi for buffalo and elephant, or fly in after Ruaha when you have extra nights.' },
    ],
    seasons: [
      { title: 'July–late October', body: 'Long dry season. Chimps lower on the mountain; walks are shorter. Best combined with Katavi.' },
      { title: 'Shoulder months', body: 'Chimps still viewable; expect longer, harder treks. Some camps are seasonal.' },
    ],
    wildlife: [
      'Chimpanzees — the reason to come; sightings are reliable, walk length is not.',
      'Other primates and excellent forest birding.',
      'Hippo and crocodile close to camp water; leopard present but lucky.',
    ],
    activities: [
      { title: 'Chimp trekking', body: 'Forest days from camp. Fitness required; duration depends on where the group is feeding.' },
      { title: 'Lake time', body: 'Kayak, snorkel, fish, or walk the shoreline.' },
      { title: 'Waterfall and forest walks', body: 'Birds and smaller primates when you are not on a chimp permit.' },
    ],
    attractions: ['Mahale Mountains', 'Lake Tanganyika beaches', 'Chimpanzee habitat', 'Forest waterfalls'],
    faqs: [
      { q: 'Gombe or Mahale?', a: 'Gombe is shorter and accessed via Kigoma. Mahale is a fly-in stay with more lake time and, in late dry season, often easier chimp walks. Budget and nights decide it.' },
      { q: 'Can it combine with Serengeti?', a: 'Yes, as a fly-in after the northern circuit — but westbound flights are not daily. We build dates around the aircraft, not the other way around.' },
      { q: 'How long with the chimps?', a: 'One hour once you find them, by park rule. The walk to get there can be an hour or most of the day.' },
      { q: 'Is Katavi worth adding?', a: 'In the dry season, yes: inland floodplain with enormous buffalo and elephant herds, a different west from forest chimps.' },
    ],
    facts: [
      ['Region', 'Far western Tanzania, Lake Tanganyika'],
      ['Focus', 'Chimpanzees, lake, forest'],
      ['Access', 'Fly-in; flights not daily'],
      ['Time with chimps', '1 hour (park rule)'],
      ['Best Time', 'July–October (easiest trekking)'],
    ],
    location: 'Western Tanzania, Lake Tanganyika',
  },
];
